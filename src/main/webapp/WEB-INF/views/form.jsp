    ...
    <div class="form--steps-container">
        ...
        <form:form method="post" modelAttribute="donation" id="my_form">
            ...
            <div data-step="1" class="active">
                ...
                <p style="font-size: large;line-height: 40px"><form:checkboxes path="categories" items="${categories}"
                                                                               itemLabel="name"
                                                                               itemValue="id" id="category"
                                                                               delimiter="<br/>"/></p><br>
            ...
            <div data-step="3">
                ...
                <p style="font-size: large;line-height: 40px"><form:radiobuttons path="institution"
                                                                                 items="${institutions}"
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> Data <form:input type="date" path="pickUpDate" id="date"/> <form:errors
                                    path="pickUpDate"/> </label>
                        </div>

                        <div class="form-group form-group--inline">
                            <label> Godzina <form:input type="time" path="pickUpTime" id="time"/> <form:errors
